...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean<MessageDispatcherServlet> messageDispatcherServlet(
        ...
        return new ServletRegistrationBean<>(servlet, "/talons/schedule/*");
    }
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema scheduleSchema) {
        ...
        wsdl11Definition.setLocationUri("/talons/schedule");
        wsdl11Definition.setTargetNamespace("http://www.namazov.ru/pas/talon/controller/soap");
